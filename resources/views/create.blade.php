                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control @error('full_name') is-invalid @enderror"
                                       name="full_name" value="{{ old('full_name') }}" placeholder="e.g. Amal Bandara Perera">
                                @error('full_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Email / Username</label>
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                       name="email" value="{{ old('email') }}" placeholder="employee@example.com">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control"
                                       name="full_name_with_initials" value="{{ old('full_name_with_initials') }}" placeholder="e.g. A.B. Perera">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">NIC Number</label>
                                <input type="text" class="form-control @error('nic_number') is-invalid @enderror"
                                       name="nic_number" value="{{ old('nic_number') }}" placeholder="e.g. 199012345678 or 901234567V">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" class="form-control @error('birthday') is-invalid @enderror"
                                       name="birthday" value="{{ old('birthday') }}" id="birthdayInput">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="race_religion" value="{{ old('race_religion') }}" placeholder="e.g. Sinhalese / Buddhist">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="permanent_address" rows="2" placeholder="Permanent residential address">{{ old('permanent_address') }}</textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Current Address</label>
                                <textarea class="form-control" name="address" rows="2" placeholder="Current address if different from permanent">{{ old('address') }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('phone_number') is-invalid @enderror"
                                           name="phone_number" value="{{ old('phone_number') }}" placeholder="0112345678">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('mobile_no') is-invalid @enderror"
                                           name="mobile_no" value="{{ old('mobile_no') }}" placeholder="0771234567">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('whatsapp_no') is-invalid @enderror"
                                           name="whatsapp_no" value="{{ old('whatsapp_no') }}" placeholder="0771234567">
                                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('designation') is-invalid @enderror"
                                       name="designation" value="{{ old('designation') }}" placeholder="e.g. Education Officer">
                                @error('designation')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Grade</label>
                                <input type="text" class="form-control" name="grade" value="{{ old('grade') }}" placeholder="e.g. Grade I">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Section</label>
                                <input type="text" class="form-control" name="section" value="{{ old('section') }}" placeholder="e.g. Finance">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Workplace / Station</label>
                                <input type="text" class="form-control" name="workplace" value="{{ old('workplace') }}" placeholder="e.g. Zonal Education Office, Dehiovita">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">WOP No (Work Order of Placement)</label>
                                <input type="text" class="form-control" name="wop_no" value="{{ old('wop_no') }}" placeholder="e.g. MOE/SLEAS/2024/001">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control" name="assumed_duty_date" value="{{ old('assumed_duty_date') }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="service_history" rows="5"
                                          placeholder="List previous postings, dates, and roles. One entry per line.">{{ old('service_history') }}</textarea>
                            </div>
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" name="current_office_details" rows="4"
                                          placeholder="Details about the current office, duties…">{{ old('current_office_details') }}</textarea>
                            </div>
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" name="confirmation_details" rows="4"
                                          placeholder="Service confirmation date, gazette reference…">{{ old('confirmation_details') }}</textarea>
                            </div>
                            <div class="col-12">
                                <p class="section-title"><i class="fas fa-file-alt me-1"></i>EB Exams</p>
                                <textarea class="form-control" name="eb_exams" rows="4"
                                          placeholder="Efficiency Bar exam attempts and results…">{{ old('eb_exams') }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="prof_qualifications" rows="4"
                                          placeholder="e.g. CIMA, ACCA, Post Graduate Diplomas…">{{ old('prof_qualifications') }}</textarea>
                            </div>
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="trainings" rows="4"
                                          placeholder="e.g. Leadership Training – SLIDA – 2022&#10;ICT Proficiency – ICTA – 2021">{{ old('trainings') }}</textarea>
                            </div>
                        </div>
                    </div>
