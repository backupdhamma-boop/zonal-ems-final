...
<body>
    ...
    <nav class="navbar navbar-dark mb-4">
        <div class="container">
            ...
            <div class="d-flex align-items-center">
                <a href="<?php echo e(route('leaves.index')); ?>" class="btn btn-outline-light btn-sm me-3 rounded-pill px-3">
        ...
        <div class="row align-items-center mb-4">
            ...
            <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                <div class="btn-group shadow-sm rounded-pill overflow-hidden">
                    <a href="<?php echo e(route('leaves.zonal-summary-pdf')); ?>" class="btn btn-primary px-3">
            ...
            <div class="col-md-3">
                <div class="card stat-card shadow-sm h-100 border-top border-5 border-primary">
                    <div class="card-body">
                        ...
                        <h2 class="fw-bold mb-0"><?php echo e($totalEmployees); ?></h2>
            ...
            <div class="col-md-3">
                <div class="card stat-card shadow-sm h-100 border-top border-5 border-emerald">
                    <div class="card-body" style="border-top-color: var(--emerald-green);">
                        ...
                        <h2 class="fw-bold mb-0 text-success"><?php echo e($pendingApprovals); ?></h2>
                        <a href="<?php echo e(route('leaves.index')); ?>" class="small text-decoration-none mt-2 d-inline-block fw-semibold">Review Pending &rarr;</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card stat-card shadow-sm h-100 border-top border-5 border-danger">
                    <div class="card-body">
                        ...
                        <h2 class="fw-bold mb-0 text-danger"><?php echo e($onLeaveToday->count()); ?></h2>
                        <?php if($onLeaveToday->count() > 0): ?>
                            ...
                            <div class="collapse mt-2" id="todayAbsence">
                                <ul class="list-unstyled absence-list pe-2">
                                    <?php $__currentLoopData = $onLeaveToday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="border-bottom py-1 small">
                                            <span class="fw-bold"><?php echo e($lv->user->name); ?></span>
                                            <span class="text-muted d-block" style="font-size: 0.7rem;"><?php echo e($lv->user->designation); ?></span>
                                        </li>
            ...
            <div class="col-md-3">
                <div class="card stat-card shadow-sm h-100 border-top border-5 border-info">
                    <div class="card-body">
                        ...
                        <h2 class="fw-bold mb-0 text-info"><?php echo e($onLeaveTomorrow->count()); ?></h2>
                        <?php if($onLeaveTomorrow->count() > 0): ?>
                            ...
                            <div class="collapse mt-2" id="tomorrowAbsence">
                                <ul class="list-unstyled absence-list pe-2">
                                    <?php $__currentLoopData = $onLeaveTomorrow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="border-bottom py-1 small">
                                            <span class="fw-bold"><?php echo e($lv->user->name); ?></span>
                                            <span class="text-muted d-block" style="font-size: 0.7rem;"><?php echo e($lv->user->designation); ?></span>
                                        </li>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <?php if($upcomingBirthdays->count() > 0): ?>
                                <span class="badge bg-warning text-dark rounded-pill px-3"><?php echo e($upcomingBirthdays->count()); ?> Celebrating</span>
                            <?php endif; ?>
                        </div>
                                    ...
                                    <div class="p-3 rounded-4 bg-white border border-warning border-opacity-20 h-100 shadow-sm" style="border-left: 4px solid #f59e0b;">
                                        <div class="d-flex align-items-center mb-2">
                                            <div class="stat-icon bg-warning bg-opacity-10 text-warning mb-0 me-3 shadow-none overflow-hidden" style="width: 45px; height: 45px; min-width: 45px; border-radius: 10px; display: flex; align-items: center; justify-content: center;">
                                                <?php if($ub->profile_photo_path): ?>
                                                    <img src="<?php echo e(asset('storage/' . $ub->profile_photo_path)); ?>" class="w-100 h-100 object-fit-cover">
                                                <?php else: ?>
                                                    <i class="fas fa-cake-candles"></i>
                                                <?php endif; ?>
                                            </div>
                                            <div class="overflow-hidden">
                                                <h6 class="fw-bold mb-0 text-truncate" title="<?php echo e($ub->full_name ?? $ub->name); ?>"><?php echo e($ub->full_name ?? $ub->name); ?></h6>
                                                <span class="text-warning fw-bold small">
                                                    <i class="far fa-calendar-check me-1"></i><?php echo e($ub->birthday->format('M d')); ?>
                                        ...
                                        <div class="mt-2 pt-2 border-top">
                                            <span class="text-muted small d-block text-truncate">
                                                <i class="fas fa-id-badge me-1 opacity-50"></i><?php echo e($ub->designation ?? 'Staff Member'); ?>
                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                    <div class="card-header bg-white border-bottom p-3 d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('admin.staff.export')); ?>" class="btn btn-sm btn-outline-primary px-3 rounded-pill">
                                <i class="fas fa-download me-1"></i> Export Data
                            </a>
                        </div>
                    </div>
                    <div class="card-body p-4 bg-light bg-opacity-50 border-bottom">
                         <form action="<?php echo e(route('dashboard')); ?>" method="GET" class="row g-2">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-3">
                                <select name="designation" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ds): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($ds); ?>" <?php echo e(request('designation') == $ds ? 'selected' : ''); ?>><?php echo e($ds); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <select name="section" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($sec); ?>" <?php echo e(request('section') == $sec ? 'selected' : ''); ?>><?php echo e($sec); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-md-2">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="ps-4">
                                        <input type="checkbox" class="form-check-input user-checkbox" value="<?php echo e($employee->id); ?>" onchange="updateBulkButton()">
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo e($employee->profile_photo_path ? asset('storage/' . $employee->profile_photo_path) : 'https://ui-avatars.com/api/?name='.urlencode($employee->name).'&background=1e3a8a&color=fff'); ?>" 
                                                 class="rounded-circle me-3 border" width="40" height="40" alt="">
                                            <div>
                                                <div class="fw-bold text-dark"><?php echo e($employee->full_name ?? $employee->name); ?></div>
                                                <div class="text-muted small"><?php echo e($employee->email); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td><span class="badge bg-white text-dark border px-2 py-1"><?php echo e($employee->designation); ?></span></td>
                                    <td><div class="text-muted small"><i class="fas fa-building me-1"></i> <?php echo e($employee->workplace); ?></div></td>
                                    <td class="text-end pe-4">
                                        <div class="d-flex justify-content-end gap-2">
                                            <a href="<?php echo e(route('employees.pdf', $employee->id)); ?>" class="btn btn-sm btn-outline-danger px-2 rounded-pill" title="PDF Service Record">
                                                <i class="fas fa-file-pdf"></i> PDF
                                            </a>
                                            <button class="btn btn-sm btn-outline-primary px-3 rounded-pill" onclick="viewEmployee(<?php echo e($employee->id); ?>)">
                                                Profile View
                                            </button>
                                        </div>
                                    </td>
        ...
        <div class="offcanvas-body p-0">
            ...
            <div class="tab-content p-4" id="drawerTabsContent">
                ...
                <div class="tab-pane fade show active" id="overview" role="tabpanel">
                    ...
                    <h6 class="fw-bold mt-4 mb-3"><i class="fas fa-chart-pie me-2 text-primary"></i>Annual Leave Balance (<?php echo e(date('Y')); ?>)</h6>
                    <div class="row g-2">
                        <div class="col-4">
    ...
    <div class="modal fade" id="importModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                ...
                <form action="<?php echo e(route('admin.staff.import')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body p-4">
                        ...
                        <div class="alert alert-info border-0 rounded-4 p-3 mb-0">
                            ...
                            <hr class="my-2">
                            <a href="<?php echo e(route('admin.staff.template')); ?>?v=2" class="small fw-bold text-decoration-none">
    ...
    <script>
        ...
        <?php if(session('error')): ?>
            Swal.fire('Operation Error', '<?php echo e(session("error")); ?>', 'error');
        <?php endif; ?>
        ...
        function bulkDelete() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch('<?php echo e(route("employees.bulk-delete")); ?>', {
                        method: 'POST',
                        headers: {
...
<?php /**PATH D:\HR System\sms-final\resources\views\home.blade.php ENDPATH**/ ?>